...
SRC = src/main.cpp src/global_variables.cpp src/model/border/border.cpp src/model/vec2/vec2.cpp src/model/bounding_box/bounding_box.cpp src/model/bounceable/bounceable.cpp src/model/racket/racket.cpp  src/model/score/score.cpp src/model/game_board/game_board.cpp src/model/life/life.cpp src/model/ball/ball.cpp src/vue/display_game/display_game.cpp src/vue/color/colors.cpp src/controller/controller_game.cpp src/vue/canvas/canvas.cpp src/vue/figures/forme.cpp src/vue/figures/point.cpp src/vue/game_over/draw_game_over.cpp src/vue/game_win/draw_game_win.cpp src/vue/piece/brik_ui.cpp src/vue/wall/wall_game.cpp src/vue/piece/ball_ui.cpp src/vue/piece/racket_ui.cpp src/vue/ball_renderer/ball_renderer.cpp src/vue/racket_renderer/racket_renderer.cpp src/vue/brick_renderer/brick_renderer.cpp src/model/brick/basic_brick.cpp src/model/brick/brick.cpp src/model/brick/gold_brick.cpp
TARGET = arkanoid
