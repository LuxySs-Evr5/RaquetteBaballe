...
SRC = src/main.cpp src/global_variables.cpp src/in_game/in_game.cpp src/figures/point.cpp src/init_allegro/initialize_allegro.cpp src/figures/forme.cpp src/canvas/canvas.cpp src/life/life.cpp src/score/score.cpp src/wall/wall_game.cpp src/game_over/draw_game_over.cpp
TARGET = allegro
