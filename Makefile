...
SRC = src/main.cpp src/global_variables.cpp src/figures/point.cpp src/init_allegro/initialize_allegro.cpp src/init_allegro/check_init.cpp src/figures/forme.cpp src/canvas/canvas.cpp src/life/life.cpp src/score/score.cpp src/wall/wall_game.cpp
TARGET = allegro
